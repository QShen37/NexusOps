"""向量数据库服务模块
RAG的存储层，也就是将知识库分块，计算嵌入向量，存储到向量数据库的操作
"""
...
class IndexingResult:
    ...
    def add_failed_file(self, failed_file: str, error: str):
        self.failed_files[failed_file] = error
...
class VectorIndexService:
    "向量索引服务 - 负责读取文件、生成向量、存储到Milvus"

    def __init__(self):
        self.upload_path = config.upload_data_path
